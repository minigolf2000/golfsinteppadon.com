$(document).on('ready', function () {
    ...
    $("#canvas").paintable({
        width: 1.5,
        cursor: 'url("/assets/images/paint/pencil.png") 0 16, crosshair',
...
function setupTools() {
    ...
    // Add Save button
	$tools.append('<div id="save"><img src="/assets/images/paint/save.png" alt="" title="save" /></div>');
    ...
    $.each([["pencil", "eraser"]], function (index) {
        $table.append('<tr>' +
        '<td id="' + this[0] + '"><img src="/assets/images/paint/' + this[0] + '.png" alt="" title="' + this[0] + '"/></td>' +
        '<td id="' + this[1] + '"><img src="/assets/images/paint/' + this[1] + '.png" alt="" title="' + this[1] + '"/></td>' +
        '</tr>');
	});
    $tools.append($table);
    ...
    $('#eraser').on('click', function () {
        $('#canvas').paintable('options', {
            width: 16,
            cursor: 'url("/assets/images/paint/eraserCursor.png") 8 8, crosshair',
            color: 'white'
        })
        .data('erasing', true);
    });
    ...
    // Add undo button
	$tools.append('<div id="undo"><img src="/assets/images/paint/undo.png" alt="" title="undo" /></div>');
